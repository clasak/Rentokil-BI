...
export const START_PACKET_REQUIREMENTS: StartPacketRequirement[] = [
  ...
  // =============================================================================
  {
    ...
    fieldName: 'road_stations_count',
    displayName: 'Road Station Count',
    required: true,
    dataType: 'number',
    exampleValue: '25',
    extractionPattern: '(\\d+)\\s*(?:road|exterior)\\s*station',
    extractionHints: ['Road Stations', 'Exterior Stations', 'Outdoor Stations', '# Road'],
    downstreamSystems: ['PestPac', 'Inventory', 'Billing', 'Capacity Planning'],
    businessJustification: 'Determines equipment inventory, service time, and pricing.',
    salesResponsibility: true,
    opsResponsibility: true
  },
  {
    fieldId: 'SP_041',
    section: 'equipment_details',
    fieldName: 'interior_stations_count',
    displayName: 'Interior Station Count',
    required: true,
    dataType: 'number',
    exampleValue: '12',
    extractionPattern: '(\\d+)\\s*(?:interior|indoor)\\s*station',
    extractionHints: ['Interior Stations', 'Indoor Stations', 'Inside Stations', '# Interior'],
    downstreamSystems: ['PestPac', 'Inventory', 'Billing', 'Capacity Planning'],
    businessJustification: 'Determines equipment inventory, service time, and pricing.',
    salesResponsibility: true,
    opsResponsibility: true
