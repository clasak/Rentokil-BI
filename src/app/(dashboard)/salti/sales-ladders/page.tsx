...
import {
  ...
  Medal, Crown, Award, Target, DollarSign, AlertTriangle, FileText, ExternalLink, Mail
} from 'lucide-react'
      ...
      {error && (
        <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          <div className="flex items-center gap-2 text-red-700 dark:text-red-400 mb-2">
            ...
            <span className="font-semibold">Error Loading Sales Ladder Data</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            {errorType && (
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div>
                  ...
                  <p className="font-medium text-red-800 dark:text-red-200 mt-0.5">salti-sales-ladders</p>
                </div>
              </div>
            )}
            ...
            <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-red-200 dark:border-red-800">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => window.location.href = `mailto:support@rentokil.com?subject=Sales Ladder Error&body=Error: ${encodeURIComponent(error || 'Unknown error')}\nQuery: salti-sales-ladders\nType: ${errorType || 'Unknown'}`}
              >
